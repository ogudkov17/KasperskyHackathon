...
run-screen: run-monitor-screen run-manager-screen run-file-server-screen run-downloader-screen run-storage-screen run-verifier-screen run-updater-screen run-sensor
...
run-sensor:
	pipenv run python sensor/sensor.py config.ini
