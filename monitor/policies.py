...
def check_operation(id, details):
    ...
    if src == 'updater' and dst == 'storage' \
            and operation == 'get_blob':
        authorized = True
    if src == 'CDataInput' and dst == 'CDataProc' \
            and operation == 'proc_data':
        authorized = True
    if src == 'CDataProc' and dst == 'CDataComparator' \
            and operation == 'compare_data':
        authorized = True
    if src == 'CDataInput' and dst == 'CDataSign' \
            and operation == 'sign_data':
        authorized = True
    if src == 'CDataSign' and dst == 'CDataInput' \
            and operation == 'signed_data':
        authorized = True
    if src == 'CDataComparator' and dst == 'CDataVerifySign' \
            and operation == 'verify_sign':
        authorized = True
    if src == 'CDataVerifySign' and dst == 'CDataComparator' \
            and operation == 'verified_sign':
        authorized = True
    if src == 'CDataProc' and dst == 'CDataOutput' \
            and operation == 'put_data':
        authorized = True
